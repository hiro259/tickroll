                ...
                child: Card(
                  child: ListTile(
                    ...
                    title: TickTitleList[index].istitleEditing
                        ...
                        : Container(
                            alignment: Alignment.topLeft, // 左寄せに設定
                            child: Padding(
                              padding: EdgeInsets.symmetric(
                                  horizontal: 2.0), // クリック範囲を狭める
                              child: TextButton(
                                onPressed: () {
                                  setState(() {
                    ...
                    //パディングがなくても動作することがわかったが表示がズレる原因はAlignだったうーんどうしよう。-----------------------
